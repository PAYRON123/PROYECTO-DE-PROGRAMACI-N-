...
class DateSortingApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Ordenador de Fechas con Merge Sort")
        ...
        self.sorted_dates_label = tk.Label(self.result_frame, text="USO DEL METODO MERGE SORT",
    ...
    def sort_dates(self):
        if len(self.dates) > 0:
            setup_code = f"from __main__ import merge_sort, psutil; dates = {self.dates}"
